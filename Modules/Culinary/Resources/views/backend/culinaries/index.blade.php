                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("culinary::text.slug")
                            </th>
                            <th>
                                @lang("culinary::text.updated_at")
                            </th>
                            <th>
                                @lang("culinary::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("culinary::text.action")
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a href='{!!route("backend.culinaries.menus.index", $module_name_singular->id)!!}' class='btn btn-sm btn-info mt-1 text-white' data-toggle="tooltip" title="Manage Menus"><i class="fas fa-utensils"></i></a>
