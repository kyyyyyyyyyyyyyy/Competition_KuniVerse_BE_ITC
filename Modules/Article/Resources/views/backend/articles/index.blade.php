                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("article::text.title")
                            </th>
                            <th>
                                @lang("article::text.content")
                            </th>
                            <th>
                                @lang("article::text.author")
                            </th>
                            <th>
                                @lang("article::text.category")
                            </th>                                                        
                            <th>
                                @lang("article::text.updated_at")
                            </th>
                            <th>
                                @lang("article::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("article::text.action")
                            </th>
                        </tr>
                    </thead>
