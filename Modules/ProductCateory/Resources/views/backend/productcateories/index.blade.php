                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("productcateory::text.name")
                            </th>
                            <th>
                                @lang("productcateory::text.slug")
                            </th>
                            <th>
                                @lang("productcateory::text.updated_at")
                            </th>
                            <th>
                                @lang("productcateory::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("productcateory::text.action")
                            </th>
                        </tr>
                    </thead>
