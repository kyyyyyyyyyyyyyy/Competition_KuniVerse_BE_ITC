                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("umkmproduct::text.name")
                            </th>
                            <th>
                                @lang("umkmproduct::text.description")
                            </th>
                            <th>
                                @lang("umkmproduct::text.price")
                            </th>
                            <th>
                                @lang("umkmproduct::text.note")
                            </th>
                            <th>
                                @lang("umkmproduct::text.slug")
                            </th>
                            <th>
                                @lang("umkmproduct::text.updated_at")
                            </th>
                            <th>
                                @lang("umkmproduct::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("umkmproduct::text.action")
                            </th>
                        </tr>
                    </thead>
