...
namespace Modules\UMKMProduct\Http\Controllers\Backend;
...
class UMKMProductsController extends BackendBaseController
{
    use Authorizable;
    ...
    public function __construct()
    {
        ...
        $this->module_path = 'umkmproduct::backend';
    ...
    public function create()
    {
        ...
        return view(
            ...
            compact('module_title', 'module_name', 'module_path', 'module_icon', 'module_name_singular', 'module_action', 'selectOptions')
        );
    }
